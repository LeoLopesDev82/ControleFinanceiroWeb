 ...
 * Anything reaching innerHTML that originated from pasted text, a database
 * record or a server message must go through this first.
 * @param {*} value - The value to escape.
 * @returns {string} The escaped text, empty when the value is null.
 */
